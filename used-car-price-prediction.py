...
# 分析无关数据清理
data = data.drop(['order', 'region_url', 'lat', 'long', 'posting_date', 'url', 'VIN', 'id', 'image_url', 'paint_color'],
                 axis=1)
# print(data)
...
# 绘制不同参数下的回归图
sns.lmplot('price', 'odometer', data, hue='manufacturer', col='manufacturer', row='fuel', palette='plasma',
           fit_reg=True)
