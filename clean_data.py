...
with open(".\\dataset\\original_data.csv", encoding='gb18030', errors='ignore') as f:
...
# 删除必填项为空的行
df.dropna(subset=['id', 'url', 'region', 'region_url', 'price', 'year', 'manufacturer', 'model', 'condition', 'fuel',
                  'odometer', 'title_status', 'transmission', 'VIN', 'drive', 'type', 'image_url', 'state',
                  'posting_date'],
          axis=0,  # axis=0表示删除行；
